...
return {
  {
    ...
    opts = function(_, opts)
      ...
      list_insert_unique(opts.ensure_installed, { "javascript", "typescript", "tsx" })
    end,
  },
  {
    ...
    opts = function(_, opts)
      ...
      list_insert_unique(opts.ensure_installed, "tsserver")
    end,
  },
  {
  ...
  },
  {
    ...
    opts = function(_, opts)
      ...
      list_insert_unique(opts.ensure_installed, "js")
    end,
  },
  {
  ...
  },
  {
    ...
    init = function() list_insert_unique(astronvim.lsp.skip_setup, "tsserver") end,
    ft = {
      "typescript",
      "typescriptreact",
      "javascript",
