...
return {
  ...
  -- Cmp Menu
  CmpItemKindCopilot = { fg = colors.green, bg = colors.bg },
  CmpItemKindKeyword = { fg = colors.turquoise, bg = colors.bg },
  CmpItemKindVariable = { fg = colors.purple, bg = colors.bg },
  CmpItemKindConstant = { fg = colors.purple, bg = colors.bg },
  CmpItemKindReference = { fg = colors.purple, bg = colors.bg },
  CmpItemKindValue = { fg = colors.purple, bg = colors.bg },
  CmpItemKindFunction = { fg = colors.hint, bg = colors.bg },
  CmpItemKindMethod = { fg = colors.hint, bg = colors.bg },
  CmpItemKindConstructor = { fg = colors.hint, bg = colors.bg },
  CmpItemKindClass = { fg = colors.warning, bg = colors.bg },
  CmpItemKindEnum = { fg = colors.warning, bg = colors.bg },
  CmpItemKindEvent = { fg = colors.warning, bg = colors.bg },
  CmpItemKindInterface = { fg = colors.warning, bg = colors.bg },
  CmpItemKindStruct = { fg = colors.warning, bg = colors.bg },
  CmpItemKindUnit = { fg = colors.warning, bg = colors.bg },
  CmpItemKindModule = { fg = colors.pink, bg = colors.bg },
  CmpItemKindEnumMember = { fg = colors.green, bg = colors.bg },
  CmpItemKindField = { fg = colors.green, bg = colors.bg },
  CmpItemKindOperator = { fg = colors.green, bg = colors.bg },
  CmpItemKindProperty = { fg = colors.green, bg = colors.bg },
  CmpItemKindTypeParameter = { fg = colors.green, bg = colors.bg },
  CmpItemKindSnippet = { fg = colors.lighter_comment, bg = colors.bg },
  -- Noice
  NoiceCmdlinePopupBorder = { fg = colors.onyx },
  NoiceConfirmBorder = { fg = colors.onyx },
}
